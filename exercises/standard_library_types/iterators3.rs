...
mod tests {
    ...
    fn result_with_list() {
        ...
        // NOTE: The collect() function is Rust's way of doing sequence 
        // https://stackoverflow.com/questions/33566286/does-rust-have-an-equivalent-to-haskells-sequence-function
